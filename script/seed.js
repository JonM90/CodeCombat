...
async function seed () {
  ...
  const users = await Promise.all([
    ...
    User.create({name: 'Samurai Jack', email: 'Jack@email.com', password: '123', rank: 2, points: 45, isAdmin: false, battleWin: 15, battleLoss: 8, profileImage: 'http://img.sharetv.com/shows/characters/thumbnails/samurai_jack.samurai_jack.jpg'}),
    User.create({name: 'Jonathan', email: 'Jonathan@email.com', password: '123', rank: 1, points: 0, isAdmin: false, battleWin: 17, battleLoss: 7})
  ])
