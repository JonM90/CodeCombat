...
Problem.create(
  {
    ...
    testSpecs: [
               'assert.equal(frequencyAnalysis("abca"), {a: 2, b: 1, c: 1})', 
               'assert.equal(frequencyAnalysis(""), {})', 
               'assert.equal(frequencyAnalysis("xxyyyz"), { x: 2, y: 3, z: 1 })'
               ], 
    authorId: 1
  }
),
...
Problem.create(
  {
    ...
    testSpecs: [
               ...
               'assert.equal(flatten([2, [3, 4, 11, 13]]), [ 2, 3, 4, 11, 13 ])', 
               'assert.equal(flatten([11, [0], 19, 7]), [ 11, 0, 19, 7 ])'
               ], 
    authorId: 1
 }
),
