...
async function seed () {
  ...
  const users = await Promise.all([
    User.create({name: 'Samurai Jack', email: 'Jack@email.com', password: '123', rank: 1, score: 0, isAdmin: false, battleWin:17, battleLoss:7, profileImage:'http://img.sharetv.com/shows/characters/thumbnails/samurai_jack.samurai_jack.jpg'}),
    User.create({name: 'Jonathan', email: 'Jonathan@email.com', password: '123', rank: 1, score: 0, isAdmin: false, battleWin:17, battleLoss:7, profileImage:'http://img.sharetv.com/shows/characters/thumbnails/samurai_jack.samurai_jack.jpg'})
  ])
